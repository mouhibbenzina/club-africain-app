      ...
      >
        ...
        <View style={styles.section}>
          <View style={styles.sectionLabelRow}>
            <Ionicons name="football" size={14} color={color} />
            <Text style={styles.sectionLabel}> Matchs</Text>
          </View>
          {liveMatches.map(m => (
            <TouchableOpacity
              key={m.id}
        ...
        <View style={styles.section}>
          <View style={styles.sectionLabelRow}>
            ...
            <Text style={styles.sectionLabel}> Effectif</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  sectionLabel: { color: Colors.textPrimary, fontSize: FontSize.subtitle, fontWeight: '700' },
