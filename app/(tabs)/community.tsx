  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined} keyboardVerticalOffset={90}>
      ...
      <View style={styles.quickActions}>
        <TouchableOpacity style={styles.quickBtn} onPress={() => router.push('/community-members')}>
          <Ionicons name="people-outline" size={16} color={Colors.primary} />
          <Text style={styles.quickBtnText}>Membres</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.quickBtn} onPress={() => router.push('/friends')}>
...
const styles = StyleSheet.create({
  ...
  quickActions: { flexDirection: 'row', gap: 10, paddingHorizontal: Spacing.lg, marginTop: 10 },
  quickBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: Colors.surface, borderRadius: Radius.pill, paddingHorizontal: 14, paddingVertical: 8, borderWidth: 1, borderColor: Colors.border },
  quickBtnText: { color: Colors.textPrimary, fontSize: FontSize.label, fontWeight: '700' },
