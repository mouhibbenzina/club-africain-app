...
export default function AuthScreen() {
  ...
  const openForgot = () => {
    Linking.openURL(`${API.BASE_URL}/auth/forgot`).catch(() => setError('Impossible d\'ouvrir la page de récupération'));
  };
    ...
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      <View style={styles.form}>
        ...
        <TextInput
          ...
          editable={!isLoading}
        />
        <TouchableOpacity style={[styles.primaryBtn, (isLoading || !email.trim() || !password) && styles.btnDisabled]} onPress={handleLogin} disabled={isLoading || !email.trim() || !password}>
          {isLoading ? (
        ...
        <TouchableOpacity style={styles.forgotRow} onPress={openForgot} disabled={isLoading}>
...
const styles = StyleSheet.create({
  ...
  forgotText: { color: Colors.textSecondary, fontSize: FontSize.label, textDecorationLine: 'underline' },
